 ...
 */
function bizreview_fboauth_action__connect($variables) {
  ...
  return '<p class="rtecenter"> <a ' . $attributes . ' href="' . $url . '"><button class="btn btn-lg btn-primary" type="button"><i class="fa fa-facebook"></i>&nbsp; Facebook Login</button></a></p> ';
}
